#ifndef GRAPHMODELGRAPHITEM5_H
#define GRAPHMODELGRAPHITEM5_H
...
class GraphModelGraphicsItem5 : public QObject, public QGraphicsRectItem
{
    Q_OBJECT
public:
    GraphModelGraphicsItem5(GraphModel* model, QGraphicsItem * parent = 0);
    bool isHidden();
